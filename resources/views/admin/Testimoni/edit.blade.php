        ...
        <div class="card-body">
            <form action="{{ route('Testimoni.update',$Testimoni->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="basic-default-fullname" value="{{$Testimoni->judul}}" name="judul">
                </div>
                <div class="mb-3">
                    <label class="form-label" for="basic-default-fullname">jabatan</label>
                    <input type="text" class="form-control" id="basic-default-fullname" value="{{$Testimoni->jabatan}}" name="jabatan">
                </div>
                <div class="mb-3">
                    <label class="form-label" for="basic-default-fullname">perusahaan</label>
                    <input type="text" class="form-control" id="basic-default-fullname" value="{{$Testimoni->perusahaan}}" name="perusahaan">
                </div>
                <div class="mb-3">
