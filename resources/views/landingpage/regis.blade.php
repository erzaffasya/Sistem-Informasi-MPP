                                ...
                                <div class="contact-form">
                                    <form action="#!">
                                        <div class="form-group mb-4 pb-2">
                                            ...
                                            <input type="text" class="form-control shadow-none" id="namalengkap">
                                        </div>
                                        <div class="form-group mb-4 pb-2">
                                            <label for="exampleFormControlInput1" class="form-label">NIK</label>
                                            <input type="text" class="form-control shadow-none" id="nik">
                                        </div>
                                        <div class="form-group mb-4 pb-2">
                                        ...
                                        <div class="form-group mb-4 pb-2">
                                            ...
                                            <input type="text" class="form-control shadow-none" id="nohp">
                                        </div>
                                        <div class="form-group mb-4 pb-2">
