                                ...
                                <div class="col-md-6" data-aos="fade">
                                    <article class="blog-post">
                                        ...
                                        <div class="pt-4">
                                            ...
                                            <h2 class="h4"><a class="text-black" href="blog-details.html">Kunjungan
                                                    Ke MPP Kota Balikpapan tahun 2022</a></h2>
                                            <p>It’s no secret that the digital industry is booming. From exciting
                                                startups to global …</p> <a href="blog-details.html"
                            ...
                            <a class="text-black" href="/blog/elements/">
                                <div class="widget-post-image flex-shrink-0 me-3">
                                    <img class="rounded" loading="lazy" decoding="async"
                                        src="tlandingpage/images/blog/post-4.jpg" alt="Post Thumbnail">
                                </div>
                            </a>
                            <div class="flex-grow-1">
                                <h5 class="h6 mb-0"><a class="text-black" href="blog-details.html">Elements That You Can
                                        Use To Create A New Post On This Template.</a></h5>
                    ...
                    <ul class="list-unstyled widget-list">
                        <li class="d-flex widget-post align-items-center">
                            <a class="text-black" href="/blog/post-1/">
                                <div class="widget-post-image flex-shrink-0 me-3">
                                    <img class="rounded" loading="lazy" decoding="async"
                                        src="tlandingpage/images/blog/post-1.jpg" alt="Post Thumbnail">
                                </div>
                            </a>
                            <div class="flex-grow-1">
