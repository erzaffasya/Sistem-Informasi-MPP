            ...
            <div class="row">
                <div class="col-8 mx-auto text-center">
                    ...
                    <ul class="list-inline breadcrumbs text-capitalize" style="font-weight:500">
                        ...
                        <li class="list-inline-item">/ &nbsp; <a href="contact.html">Register</a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="col-lg-6">
                    <div class="shadow rounded p-5 bg-white">
                        <div class="section-title text-center mb-2">
                            <p class="text-primary text-uppercase fw-bold mb-3">Form Lupa Password Akun MPP Kota Balikpapan</p>
                            {{-- <h1>Formulir Lupa Password</h1> --}}
                        </div>
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="contact-form">
                                    <form action="{{route('post-lupa-password')}}" method="post">
                                        @csrf
                                        <div class="form-group mb-4 pb-2">
                                            <label for="exampleFormControlInput1" class="form-label">Alamat Email</label>
                                            <input type="email" name="email" class="form-control shadow-none" id="email">
                                        </div>
                                        <button class="btn btn-primary w-100" type="submit">LUPA PASSWORD</button>
                                    </form>
                                </div>
                            </div>
