            ...
            <div class="row justify-content-center">
                ...
                <div class="icon-box-item text-center col-lg-4 col-md-6 mb-4">
                    <div class="rounded shadow py-5 px-4">
                        ...
                        <h3 class="mb-3">{{$item->nama_instansi}}</h3>
                        <p class="mb-4">{!!$item->deskripsi!!}</p> <a class="btn btn-sm btn-outline-primary" href="{{url('layanan/'.$item->slug)}}">View Details <i class="las la-arrow-right ms-1"></i></a>
                    </div>
                </div>
                @endforeach
            </div>
